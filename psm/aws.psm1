...
function Upload-Jar
{
    ...
    $AwsCmd = "aws s3 cp ../out/artifacts/$Role.jar s3://webrtc-webrtc/core/$Environment/$Role.jar"
    Write-Host "Using AWS command: $AwsCmd"
...
function Upload-Folder
{
    ...
    $AwsCmd = "aws s3 sync ../services/signaling s3://webrtc-webrtc/core/$Environment/$Role --size-only --delete"
    Write-Host "Using AWS command: $AwsCmd"
